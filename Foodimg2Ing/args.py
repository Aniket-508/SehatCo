...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="resnet50",
        choices=["resnet18", "resnet50", "resnet101", "resnet152", "inception_v3"],
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=224,
        help="size for randomly or center cropping images",
    )

    parser.add_argument(
        "--image_size", type=int, default=256, help="size to rescale images"
    )
    ...
    parser.add_argument(
        "--learning_rate", type=float, default=0.001, help="base learning rate"
    )

    parser.add_argument(
        "--scale_learning_rate_cnn",
        type=float,
        default=0.01,
    ...
    parser.add_argument(
        "--lr_decay_rate", type=float, default=0.99, help="learning rate decay factor"
    )
    ...
    parser.add_argument(
        "--embed_size", type=int, default=512, help="hidden size for all projections"
    )
    ...
    parser.add_argument(
        "--num_epochs", type=int, default=400, help="maximum number of epochs"
    )
    ...
    parser.add_argument(
        "--maxseqlen", type=int, default=15, help="maximum length of each instruction"
    )

    parser.add_argument(
        "--maxnuminstrs", type=int, default=10, help="maximum number of instructions"
    )

    parser.add_argument(
        "--maxnumims", type=int, default=5, help="maximum number of images per sample"
    )
